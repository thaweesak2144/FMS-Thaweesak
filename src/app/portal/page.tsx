...
export default async function PortalHomePage() {
  ...
  return (
    <div className="space-y-16 py-8">
      {/* Hero Section */}
      <section className="relative overflow-hidden rounded-3xl mx-4 sm:mx-8 bg-gradient-to-br from-primary/15 via-primary/5 to-background border p-8 sm:p-16 text-center">
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <p className="text-base sm:text-lg text-muted-foreground">
            {locale === "th"
              ? "แพลตฟอร์มการบริหารจัดการและให้บริการทางการศึกษา คณาจารย์ นิสิตนักศึกษา และประชาชนทั่วไป"
              : "Comprehensive academic, research, and administrative management platform for faculty, students, and the public."}
          </p>
          <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
            <Link href="/portal/personnel">
              <Button size="lg" className="gap-2 text-sm shadow-md">
            ...
            <Link href="/login">
              <Button size="lg" variant="outline" className="text-sm">
                {locale === "th" ? "เข้าสู่ระบบจัดการหลังบ้าน" : "Staff Console"}
              </Button>
            </Link>
          </div>
        </div>
