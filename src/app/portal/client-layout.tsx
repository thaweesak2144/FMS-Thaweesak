      ...
      <header className="sticky top-0 z-40 w-full border-b bg-background/85 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <Link href="/portal" className="flex items-center gap-3 group">
            {logoUrl ? <img src={logoUrl} alt="Logo" className="h-10 object-contain group-hover:scale-105 transition-transform" /> : <div className="h-10 w-10 rounded-xl bg-primary flex items-center justify-center text-primary-foreground shadow-sm group-hover:scale-105 transition-transform"><GraduationCap className="h-6 w-6" /></div>}
            <div>
